...
For `phase-1-discover`, dispatch the `site-crawler` agent with explicit instructions: "Re-read crawl.json and probe.json, ask the user only for missing ABORT confirmations, and re-emit verification.json."
