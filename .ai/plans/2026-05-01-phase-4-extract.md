...
**Spec source:** `docs/specs/2026-04-21-migration-plugin-design.md` § 5 row 4 (Phase 4 — Extract), § 9 (`/migrate:extract`), § 10 (`page-extractor` agent), § 12 (parallelism), § 14 (vendored scripts policy).
...
Plan complete and saved to `.ai/plans/2026-05-01-phase-4-extract.md`. Two execution options:
