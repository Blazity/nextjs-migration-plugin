...
**Spec source:** `docs/specs/2026-04-21-migration-plugin-design.md` § 5 (Phase 2 row), § 9 (`/migrate:analyze`), § 10 (the four new agents), § 11 (hybrid analysis approach).
...
Plan complete and saved to `.ai/plans/2026-04-30-phase-2-analyze.md`. Two execution options:
