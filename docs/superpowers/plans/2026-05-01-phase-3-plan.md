...
**Spec source:** `docs/superpowers/specs/2026-04-21-migration-plugin-design.md` § 5 row 3 (Phase 3), § 9 (`/migrate:plan`), § 10 (`migration-planner` + `plan-checker`), § 11.4 (LLM cost bound), § 4 (`ROADMAP.md` location).
...
- `docs/superpowers/plans/2026-04-30-phase-2-analyze.md` (executed; library + analyze pipeline shipped)
...
Plan complete and saved to `docs/superpowers/plans/2026-05-01-phase-3-plan.md`. Two execution options:
