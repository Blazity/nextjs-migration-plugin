...
**Spec source:** `docs/superpowers/specs/2026-04-21-migration-plugin-design.md` § 5 row 5 (Phase 5 — Build), § 9 (`/migrate:build`), § 10 (`page-builder` agent), § 12 (parallelism), § 14 (vendored scripts policy).
...
- `docs/superpowers/plans/2026-05-01-phase-4-extract.md` (executed)
