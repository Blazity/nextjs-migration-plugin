...
**Spec source:** `docs/superpowers/specs/2026-04-21-migration-plugin-design.md`
...
See `docs/superpowers/specs/2026-04-21-migration-plugin-design.md` in the companion repo for design details.
...
Plan complete and saved to `docs/superpowers/plans/2026-04-21-plugin-foundation.md`. Two execution options:
